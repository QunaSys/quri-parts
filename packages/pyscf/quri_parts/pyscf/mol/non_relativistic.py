...
def get_spin_mo_integrals_from_mole(
...
) -> tuple[ActiveSpace, float, SpinMOeIntSet]:
    ...
    # mo.spin is divided by 2 to cope with pyscf's convention
    # that mo.spin = 2 * sz
    sz = mo.spin / 2
    ...
    return active_space, sz, ao_eint_set.to_active_space_mo_int(asmo)
