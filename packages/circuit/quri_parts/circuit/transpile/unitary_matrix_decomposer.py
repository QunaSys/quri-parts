...
class TwoQubitUnitaryMatrixKAKTranspiler(GateDecomposer):
    ...
    def decompose(self, gate: QuantumGate) -> Sequence[QuantumGate]:
        ...
        return [
            ...
            gates.RZ(q1, xi[1][2]),
            gates.CNOT(q0, q1),
            gates.RX(q0, -2.0 * alpha[0]),
            gates.H(q0),
            gates.RZ(q1, -2.0 * alpha[2]),
            gates.CNOT(q0, q1),
            gates.S(q0),
            gates.H(q0),
            gates.RZ(q1, 2.0 * alpha[1]),
            gates.CNOT(q0, q1),
            gates.RX(q0, -np.pi / 2.0),
            gates.RZ(q0, xi_prime[0][0]),
            gates.RY(q0, xi_prime[0][1]),
            gates.RZ(q0, xi_prime[0][2]),
            gates.RX(q1, np.pi / 2.0),
            gates.RZ(q1, xi_prime[1][0]),
            gates.RY(q1, xi_prime[1][1]),
            gates.RZ(q1, xi_prime[1][2]),
        ]
